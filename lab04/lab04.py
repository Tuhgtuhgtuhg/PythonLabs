...
if __name__ == '__main__':
    ...
    print("Випадкове речення : " + str(random_sentence(list1, list2, list3)))
    print("Кількість унікальних слів у тексті: "+ str(how_word_in_file_unical("бернар вербер древо возможностей сборник.txt")))
    print("Кількість речень у тексті: "+str(how_sentences_in_file("бернар вербер древо возможностей сборник.txt")))    
